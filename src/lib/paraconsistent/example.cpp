...
//
//static void randomlyPopulateClassFeatureVectors(std::vector<std::vector<double>> &featureVectors, unsigned int samplesPerClass, unsigned int featureVectorSize)
//{
...
//}
//
//void populateClasses(std::map<std::string, std::vector<std::vector<double>>> &arrClasses, unsigned int amountOfClasses, unsigned int samplesPerClass, unsigned int featureVectorSize, char genRandom = 0)
//{
//
