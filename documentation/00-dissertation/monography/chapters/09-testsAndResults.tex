\chapter{Testes e Resultados} \label{chap:testsResults}
	...
	\section{Procedimento 03}
		...
		\subsection{Escala BARK com \textit{wavelet} Haar usando um classificador SVM com tamanho de modelo a 10\%}
			...
			\begin{figure}[!h]
				\centering
				\includegraphics[width=.9\linewidth]{images/results/confusionMatrices/classifier_SVM_10.png}
			...
			\begin{figure}[!h]
				\centering
				\includegraphics[width=.73\linewidth]{images/results/det/DET_SVM_10}
		...
		\subsection{Escala BARK com \textit{wavelet} Haar usando um classificador SVM com tamanho de modelo a 20\%}
			...
			\begin{figure}[h]
				\centering
				\includegraphics[width=\linewidth]{images/results/confusionMatrices/classifier_SVM_20.png}
			...
			\begin{figure}[h]
				\centering
				\includegraphics[width=\linewidth]{images/results/det/DET_SVM_20}
		...
		\subsection{Escala BARK com \textit{wavelet} Haar usando um classificador SVM com tamanho de modelo a 30\%}
			...
			\begin{figure}[h]
				\centering
				\includegraphics[width=.9\linewidth]{images/results/det/DET_SVM_30}
		...
		\subsection{Escala BARK com \textit{wavelet} Haar usando um classificador SVM com tamanho de modelo a 40\%}
			...
			\begin{figure}[ht]
				\centering
				\includegraphics[width=\linewidth]{images/results/confusionMatrices/classifier_SVM_40.png}
			...
			\begin{figure}[!h]
				\centering
				\includegraphics[width=\linewidth]{images/results/det/DET_SVM_40}
	...
	\label{chap:testsResults:sec:Experimento05}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[width=.66\linewidth]{images/results/barkVersusMel/liveHaarBark}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[width=.66\linewidth]{images/results/barkVersusMel/spoofingHaarBark}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[width=.66\linewidth]{images/results/barkVersusMel/liveDaub42Bark}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[width=.66\linewidth]{images/results/barkVersusMel/spoofingDaub42Bark}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[width=.66\linewidth]{images/results/barkVersusMel/liveHaarMel}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[width=.66\linewidth]{images/results/barkVersusMel/spoofingHaarMel}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[width=.66\linewidth]{images/results/barkVersusMel/liveDaub54Mel}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[width=.66\linewidth]{images/results/barkVersusMel/spoofingDaub54Mel}
