\chapter{Testes e Resultados} \label{chap:testsResults}
	...
	\section{Procedimento 02} \label{chap:testsResults:sec:Experimento02}
		...
		\subsection{Escala BARK com \textit{wavelet} Haar usando um classificador de distância Euclidiana com tamanho de modelo a 10\%}
			...
			\begin{figure}[!t]
				\centering
				\includegraphics[width=.8\linewidth]{images/results/confusionMatrices/classifier_Euclidian_10}
			...
			\begin{figure}[h]
				\centering
				\includegraphics[width=.7\linewidth]{images/results/det/DET_for_classifier_Euclidian_10}
		...
		\subsection{Escala BARK com \textit{wavelet} Haar usando um classificador de distância Euclidiana com tamanho de modelo a 50\%}
			...
			\begin{figure}[ht]
				\centering
				\includegraphics[width=.8\linewidth]{images/results/det/DET_for_classifier_Euclidian_50}
		...
		\subsection{Escala BARK com \textit{wavelet} Haar usando um classificador de distância Manhattan com tamanho de modelo a 20\%}
			...
			\begin{figure}[ht]
				\centering
				\includegraphics[width=.8\linewidth]{images/results/det/DET_for_classifier_Manhattan_20}
		...
		\subsection{Escala BARK com \textit{wavelet} Haar usando um classificador de distância Manhattan com tamanho de modelo a 40\%}
			...
			\begin{figure}[ht]
				\centering
				\includegraphics[width=.8\linewidth]{images/results/det/DET_for_classifier_Manhattan_40}
	...
	\section{Procedimento 03}
		...
		\subsection{Escala BARK com \textit{wavelet} Haar usando um classificador SVM com tamanho de modelo a 50\%}
			...
			\begin{figure}[!h]
				\centering
				\includegraphics[width=.95\linewidth]{images/results/confusionMatrices/classifier_SVM_50.png}
