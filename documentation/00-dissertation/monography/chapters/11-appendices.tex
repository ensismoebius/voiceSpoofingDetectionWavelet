\begin{apendicesenv}
	...
	\chapter{Recursos na web}
		...
		\par Todos esses materiais estão sob licenças de código aberto (GPLv3) e são livres para uso não comercial acesse   \href{https://github.com/ensismoebius/mestrado}{https://github.com/ensismoebius/mestrado} para mais informações.
\end{apendicesenv}
