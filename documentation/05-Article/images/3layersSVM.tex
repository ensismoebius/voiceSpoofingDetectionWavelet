\begin{figure}[H]
	...
	\scalebox{2}{
		\begin{tikzpicture}
			...
			\node (IL_N1) at (1.5,2.0) {}; \filldraw[fill=teal!30] (1.5,2.0) circle (0.15cm);
			\node (IL_N2) at (1.5,1.5) {}; \filldraw[fill=teal!30] (1.5,1.5) circle (0.15cm);
			\node (IL_N3) at (1.5,1.0) {}; \filldraw[fill=teal!30] (1.5,1.0) circle (0.15cm);
			\node at (1.5,0.625) {$\vdots$};
			\node (IL_Nn) at (1.5,0.0) {}; \filldraw[fill=teal!30] (1.5,0.0) circle (0.15cm);
			
			%hidden layer 
			\node (HL_N1) at (3.5,2.5) {}; \filldraw[fill=orange!20] (3.55,2.5) circle (0.15cm);
			\node (HL_N2) at (3.5,2.0) {}; \filldraw[fill=orange!20] (3.55,2.0) circle (0.15cm);
			\node (HL_N3) at (3.5,1.5) {}; \filldraw[fill=orange!20] (3.55,1.5) circle (0.15cm);
			\node (HL_N4) at (3.5,1.0) {}; \filldraw[fill=orange!20] (3.55,1.0) circle (0.15cm);
			\node at (3.55,0.625) {$\vdots$};
			\node (HL_Nn-1) at (3.5,0.0) {}; \filldraw[fill=orange!20] (3.55,0.0) circle (0.15cm);	
			\node (HL_Nn) at (3.5,-0.5) {}; \filldraw[fill=orange!20] (3.55,-0.5) circle (0.15cm);	
			...
			%output layer
			\node (OL_N1) at (5.5,1.0) {}; \filldraw[fill=violet!40] (5.55,1.0) circle (0.15cm);
			...
			%
			\draw[snake=brace,mirror snake,raise snake=45pt,brown] (1.25,1.25) -- (1.75,1.25) node[black,midway,yshift=-50pt,below]{\tiny input layer} node[black,midway,yshift=-58pt,below]{\tiny with passive} node[black,midway,yshift=-66pt,below]{\tiny elements}

			node[black,midway,yshift=-74pt,below]{\tiny };

			\draw[snake=brace,mirror snake,raise snake=45pt,brown] (3.25,0.75) -- (3.75,0.75) node[black,midway,yshift=-50pt,below]{\tiny hidden layer} node[black,midway,yshift=-58pt,below]{\tiny  with  non-linerar} node[black,midway,yshift=-66pt,below]{\tiny active elements}
			node[black,midway,yshift=-74pt,below]{\tiny};
			\draw[snake=brace,mirror snake,raise snake=45pt,brown] (5.25,1.75) -- (5.75,1.75) node[black,midway,yshift=-50pt,below]{\tiny output} node[black,midway,yshift=-58pt,below]{\tiny layer with} node[black,midway,yshift=-66pt,below]{\tiny one active element}
			node[black,midway,yshift=-74pt,below]{\tiny};
			%
			\node (OUT) at (6.5,1.0) {\tiny result}; 
	...
	\caption{SVM structure used in the proposed approach.}
