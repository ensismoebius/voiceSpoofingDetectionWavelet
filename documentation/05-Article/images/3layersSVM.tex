\begin{figure}[H]
	...
	\caption{SVM structure for procedure 3 with $R$ neurons in input layer, being $R$ the feature vectors length, and $X$ neurons in inner layer. $X$ is the number of trainning cases.}
