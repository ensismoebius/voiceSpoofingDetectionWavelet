...
\subsection{Experiments}
	...
	%%% Esta parte ainda é válida?
	%Notably, the same behavior has been observed with experiments in different sub-fields of signal processing \cite{guido2}\cite{guido3}\cite{guido4}.
