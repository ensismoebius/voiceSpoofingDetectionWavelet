\begin{figure}[H]
	...
	\scalebox{2}{
		\begin{tikzpicture}
			...
			%
			\draw[snake=brace,mirror snake,raise snake=45pt,brown] (1.25,1.25) -- (1.75,1.25) node[black,midway,yshift=-50pt,below]{\tiny input layer} node[black,midway,yshift=-58pt,below]{\tiny with R passive} node[black,midway,yshift=-66pt,below]{\tiny elements}

			node[black,midway,yshift=-74pt,below]{\tiny };

			\draw[snake=brace,mirror snake,raise snake=45pt,brown] (3.25,0.75) -- (3.75,0.75) node[black,midway,yshift=-50pt,below]{\tiny inner layer} node[black,midway,yshift=-58pt,below]{\tiny  with $X$ non-linerar} node[black,midway,yshift=-66pt,below]{\tiny active neurons}
			node[black,midway,yshift=-74pt,below]{\tiny};
	...
	\caption{SVM structure for procedure 03 with $R$ neurons in input layer, being $R$ the feature vectors length, and $X$ neurons in inner layer. $X$ is the number of trainning cases.}
